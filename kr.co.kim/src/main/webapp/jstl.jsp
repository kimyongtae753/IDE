...
<input type="text" name="aa" readonly="readonly"><!-- XHTML -->


<!-- jstl : out 태그 - out.print와 동일 -->
<cr:out value="값출력"></cr:out>

<!-- jstl : set 태그 값을 이관 받아서 가상의 변수(var)를 받아서 처리 setattribure -->
<cr:set var="a" value="jstl 첫수업"></cr:set><br>
<cr:set var="a" value="jstl 첫수업222"/>
${a}
${b}
<br><br><br>
<!-- c라는 변수에 user 값을 set -->
<cr:set var="c" value="<%=user%>"></cr:set>
${c}
<br><br><br>
<!-- 세션 초기값 -->
세션 기본값 : ${username}
